...
class Qwen3TTSModelLoader(BaseComponent):
    ...
    requirements = "# _qwen_tts_haigc,# comfy_qwen_tts,# folder_paths,onnxruntime,sox,mediapipe>=0.10.31,modelscope,tf-keras>=2.18,torch,transformers,transparent-background>=1.3.4"
