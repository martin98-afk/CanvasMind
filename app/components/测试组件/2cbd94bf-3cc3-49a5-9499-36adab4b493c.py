...
class Component(BaseComponent):
    ...
    inputs = [
        ...
        PortDefinition(name="input3", label="输入3", type=ArgumentType.TEXT, connection=ConnectionType.SINGLE),
    ]
    outputs = [
        PortDefinition(name="output1", label="输出1", type=ArgumentType.TEXT),
        PortDefinition(name="output2", label="输出2", type=ArgumentType.TEXT),
        PortDefinition(name="output3", label="输出3", type=ArgumentType.TEXT),
    ]
    properties = {
    }
