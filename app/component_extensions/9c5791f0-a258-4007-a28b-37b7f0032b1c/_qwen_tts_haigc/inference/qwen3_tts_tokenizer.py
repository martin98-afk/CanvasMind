...
class Qwen3TTSTokenizer:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs) -> "Qwen3TTSTokenizer":
        ...
        kwargs_local.setdefault('local_files_only', True)
        kwargs_local.setdefault('force_download', False)
        ...
        inst.model = AutoModel.from_pretrained(pretrained_model_name_or_path, **kwargs_local)
