...
STAGE_PROMPTS = {
    ...
    "→ When context is sufficient, transit to plan.",
    ...
    "→ When verification passes, transit to review.",
    ...
    "→ When review is done, transit to summarize.",
